...
**M1.5 已进入收官验证。** 当前基线为“主机范围自主 + 核心资源保护”：不设默认工作区沙箱，但数据、配置、密钥与安全实现对模型工具不可覆盖。PTY 已收窄为无原始 stdin 的受控 argv 终端。详见 [ADR-0040](./adr/0040-M1.5自主安全边界与受控终端.md) 与 [M1.5 收官报告](./M1.5-收官报告.md)。
