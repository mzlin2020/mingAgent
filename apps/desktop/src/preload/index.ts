...
contextBridge.exposeInMainWorld('xm', {
  ...
  settings: () => ipcRenderer.invoke(CH.settings),
  updateSettings: (req: unknown) => ipcRenderer.invoke(CH.updateSettings, req),
  clearSearchIndex: () => ipcRenderer.invoke(CH.clearSearchIndex),
